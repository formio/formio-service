...
module.exports = function (config) {
  ...
  Project.prototype.read = function (projectId) {
    // Send the request.
    return _request('get', config.api + '/project/' + projectId, null, {
      'x-jwt-token': token
    }).then(function(res) {
      this.project = res.body;
    }.bind(this));
  ...
  Project.prototype.update = function (project) {
    // Send the request.
    return _request('put', config.api + '/project/' + project._id, project, {
      'x-jwt-token': token
    }).then(function(res) {
      this.project = res.body;
    }.bind(this));
  ...
  Project.prototype.delete = function () {
    // Send the request.
    return _request('delete', this.projectUrl, null, {
      'x-jwt-token': token
    }).then(function(res) {
      delete this.project;
    }.bind(this));
  ...
  Project.prototype.list = function () {
    // Send the request.
    return _request('get', config.api + '/project', null, {
      'x-jwt-token': token
    }).then(function(res) {
